 ...
 * Shared icon library
 *
 * All SVG icons used in GolfCaddy live here so they are never duplicated
 * across page files. Each icon accepts a standard `className` prop for
 * Tailwind sizing/colour overrides.
 *
 * Icon naming convention: descriptive noun (HomeIcon, ChevronRightIcon, …)
 */
