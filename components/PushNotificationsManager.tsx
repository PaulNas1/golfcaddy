    ...
    <>
      {shouldShowEnablePrompt && (
        <div className="mx-auto w-full max-w-lg px-4 pt-4">
          <div className="rounded-2xl border border-brand-200 bg-brand-50 px-4 py-3 text-sm text-brand-900 shadow-sm">
      ...
      {foregroundPush && (
        <div className="pointer-events-none fixed inset-x-0 top-4 z-50 flex justify-center px-4">
          <button
            ...
            className="pointer-events-auto w-full max-w-md rounded-2xl border border-brand-200 bg-surface-card px-4 py-3 text-left shadow-lg"
          >
            <p className="text-xs font-semibold uppercase tracking-wide text-brand-700">
              New notification
            </p>
            <p className="mt-1 text-sm font-semibold text-ink-title">
              {foregroundPush.title}
            </p>
            <p className="mt-1 text-sm text-ink-muted">{foregroundPush.body}</p>
